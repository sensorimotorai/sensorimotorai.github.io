...
The formalism is worth pursuing for another reason. As we have emphasized throughout, fields mature when their central concepts become precise enough to analyze systematically. Dave's framework gives us a precise vocabulary for two properties that everyone agrees agents must have but nobody had defined in a unified way until this work. As a result, we now have some vocabulary to talk about agents, and ask questions we could not ask before. Finally, the empowerment-plasticity dilemma theorem is a true reult that will hold. It's a constraint that every theory of agency, biological or artificial, will eventually have to account for.
