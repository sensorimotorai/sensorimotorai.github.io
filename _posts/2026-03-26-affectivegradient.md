...
Perhaps, self-deception is the only true source of happiness.

If we were performing perfectly calibrated affective inference, attending to the full distribution of outcomes with accurate weights, we might find existence intolerably uncertain and painful [*you'd know what I mean if you've ever dealt with US immigration system...*]. What keeps organisms going may be precisely a *positively biased* affective inference system: one that systematically overweights the good, underweights the bad, and filters negative information through rose-tinted priors.

This idea has been explored extensively by pessimist philosophers like Schopenhauer. Another prime example is the Norwegian philosopher Peter Wessel Zapffe, who argued that human consciousness is itself a tragic overevolution. We survive, only through powerful mechanisms of self-deception ([*four of them, to be precise*](https://philosophynow.org/issues/45/The_Last_Messiah){:target="_blank" rel="noopener"}).
