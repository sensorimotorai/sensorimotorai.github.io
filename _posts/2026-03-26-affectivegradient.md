...
> **Editorial note.** Rosa's question raises a disquieting possibility: what if an unconstrained, accurate affective inference over an indifferent universe is existentially unbearable? What keeps us moving might be a positively skewed prior, imposed by evolution: a biological self-deception explored in Taylor & Brown's ["illusion and well-being (1988)"](https://psycnet.apa.org/record/1988-16903-001){:target="_blank" rel="noopener"}, and Baumeister's ["optimal margin of illusion (1989)"](https://psycnet.apa.org/record/1990-01278-001){:target="_blank" rel="noopener"} (see also [Rob Henderson's blog](https://www.robkhenderson.com/p/the-optimal-margin-of-illusion){:target="_blank" rel="noopener"}). The only true source of happiness is, perhaps, self-deception.
