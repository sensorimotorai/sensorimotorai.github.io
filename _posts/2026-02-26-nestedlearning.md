...
- Paper: [Nested Learning: The Illusion of Deep Learning Architecture](https://arxiv.org/abs/2512.24695){:target="_blank"}
    - Also see: [Miras framework](https://arxiv.org/abs/2504.13173){:target="_blank"}, [Titans architecture](https://arxiv.org/abs/2501.00663){:target="_blank"}
